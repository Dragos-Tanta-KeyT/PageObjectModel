...
public class JavascriptExecutorExample extends BaseTest {
	...
	/*	//alternativa pentru click()
		...
		*/
		...
		//intoarce sistemul pe care execut
		String platfrom = Platform.getCurrent().toString();
		System.out.println(platfrom);
		
		String platfrom2 = jse.executeScript("return navigator.platform").toString();
		System.out.println(platfrom2);
